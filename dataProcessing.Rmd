...
remove_rownames = function(names) {
  spaceship = spaceship %>% 
...
fill_in_spending_nulls_with_mice = function(spaceship) {
  ...
  # mutate
  # (
  #   RoomService = final_clean_amenity_df[ ,1],
  #   FoodCourt = final_clean_amenity_df[,2],
  #   ShoppingMall = final_clean_amenity_df[,3],
  #   Spa = final_clean_amenity_df[,4],
  #   VRDeck = final_clean_amenity_df[,5]
  # )
